...
If the app tracks a GitHub repository, branch, and directory, `Rudel::create_sandbox_from_app()` carries that metadata into the new sandbox automatically. That keeps later push/PR and deploy operations aligned with the app's declared code source.

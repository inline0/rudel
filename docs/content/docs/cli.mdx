...
```bash
wp rudel app create --domain=<domain> [--name=<name>] [--engine=<engine>] [--clone-db] [--clone-themes] [--clone-plugins] [--clone-uploads] [--clone-all] [--clone-from=<id>]
```
...
```bash
wp rudel app create-sandbox <id> [--name=<name>] [--engine=<engine>]
```

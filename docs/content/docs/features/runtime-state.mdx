...
The environments table also carries the metadata that makes higher-level workflows possible: ownership, expiry, lineage, tracked Git remote data, and the identifiers Rudel uses to connect apps, app-derived sandboxes, and deploy records back together.

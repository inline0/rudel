...
Snapshots capture the sandbox site state and its environment-owned content so you can roll back risky work quickly without promoting that recovery model into the long-lived app lifecycle.

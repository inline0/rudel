...
Snapshots capture the sandbox's cloned WordPress tables and copied active
theme files so you can roll back risky work quickly without promoting that
...
App backups capture the app's cloned WordPress tables and copied active theme
files. App deploys integrate with backups so recovery is built into the deploy
workflow rather than added as an afterthought.
